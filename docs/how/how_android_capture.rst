...
If something goes wrong with these steps, please `open an issue on GitHub <https://github.com/ripperk/ripperk/issues/new/choose>`__! The process should be as smooth as possible given Android's platform limitations, so if you encounter problems then it may well be fixable.
